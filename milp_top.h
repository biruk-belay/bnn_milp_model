...
int milp_solver_first_cut(unsigned int num_lut, unsigned int num_bram, unsigned int num_conv_layer,
...
int milp_solver_full(unsigned int num_lut, unsigned int num_bram, unsigned int num_conv_layer,
                           unsigned int num_lfc_layer, unsigned long long int *num_ops_per_layer,
                           model_variables **res_model_lfc, model_variables **res_model_conv);
